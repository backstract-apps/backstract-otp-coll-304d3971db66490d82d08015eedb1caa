...
def create_otp_log(id: UUID, created_at: str, email: str, ip: str, type: str, attempts: str, updated_at: str, db: Session = Depends(get_db)):
...
def update_otp_log_by_id(id: UUID, created_at: str, email: str, ip: str, type: str, attempts: str, updated_at: str, db: Session = Depends(get_db)):
...
def create_demo_inquiry(created_at: str, name: str, email: str, phone: str, profession: str, desc: str, status: str, updated_at: str, reapply_count: str, id: UUID, db: Session = Depends(get_db)):
...
def update_demo_inquiry_by_created_at(created_at: str, name: str, email: str, phone: str, profession: str, desc: str, status: str, updated_at: str, reapply_count: str, id: UUID, db: Session = Depends(get_db)):
...
def create_founder(id: int, name: str, email: str, linkedin_url: str, is_technical: str, age: str, gender: str, question_contribution: str, question_meet: str, invites: str, founder_video: str, company_id: int, createdAt: str, updatedAt: str, db: Session = Depends(get_db)):
...
def update_founder_by_id(id: int, name: str, email: str, linkedin_url: str, is_technical: str, age: str, gender: str, question_contribution: str, question_meet: str, invites: str, founder_video: str, company_id: int, createdAt: str, updatedAt: str, db: Session = Depends(get_db)):
...
def create_support_inquiry(id: UUID, created_at: str, status: str, phone: str, email: str, desc: str, name: str, updated_at: str, reapply_count: str, alternative_email: str, app_user: str, db: Session = Depends(get_db)):
...
def update_support_inquiry_by_id(id: UUID, created_at: str, status: str, phone: str, email: str, desc: str, name: str, updated_at: str, reapply_count: str, alternative_email: str, app_user: str, db: Session = Depends(get_db)):
...
def create_company(id: int, name: str, about: str, company_url: str, product_demo_video: str, product_url: str, why_apply_here: str, createdAt: str, updatedAt: str, db: Session = Depends(get_db)):
...
def update_company_by_id(id: int, name: str, about: str, company_url: str, product_demo_video: str, product_url: str, why_apply_here: str, createdAt: str, updatedAt: str, db: Session = Depends(get_db)):
